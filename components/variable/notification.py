...
class StaticNotificationList(NotificationList):
    ...
    def renew(self):
        ...
        self.__visible_notifications = {iden: n for iden, n in self.notifications.items() if
                                        n.is_visible(self.from_priority_level)}
...
class NumberFormatNotification(Notification):
    ...
    def draw(self, painter: Painter, x: int, y: int, w: int, h: int):
        ...
        self.style.draw(self.title, self.message.replace("{}", ("{:." + str(self.decimals) + "f}").format(value)),
                        painter, x, y, w, h)
...
class NotificationStyles:
    ...
    def from_iden(iden: str):
        ...
        elif iden == "warning-battery":
            return NotificationStyles.WARNING_BATTERY()
        elif iden == "error":
            return NotificationStyles.ERROR()
        elif iden == "crucial":
            return NotificationStyles.CRUCIAL()
