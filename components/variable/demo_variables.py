...
class DemoLoopingVariable(WatchableVariable):
    ...
    def update(self):
        self.value = ((self.value + self.increment - self.lower_val) % (self.upper_val - self.lower_val)) + self.lower_val
...
class DemoStaticVariable(WatchableVariable):
