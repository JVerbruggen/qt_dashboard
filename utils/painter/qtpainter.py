...
class HMIQtPainter(Painter):
    ...
    def draw_rounded_line(self, from_x: int, from_y: int, to_x: int, to_y: int, width: int = None, color: (int, int, int, int) = (200, 200, 200, 255)):
        if width:
    ...
    def __default_line_pen(self, color: (int, int, int, int) = (200, 200, 200, 255),
                           width: int = Painter.DEFAULT_LINE_WIDTH):
        r, g, b, a = color
